...
parser.add_argument('--image_path', default='~/data/edit_plant1/val/008.근두암', help='Input image path')
parser.add_argument('--result', default='/home/bong3/data/edit_plant_320/val/008.근두암', help='Output cam file dir name.')
